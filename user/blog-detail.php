...
include 'connect.php';
$sql = $con->prepare("SELECT * FROM `blogs` WHERE BlogID =$id");
$sql->execute();
$single_blog = $sql->fetchAll();
...
<div class="page-wrapper">
    ...
    <div class="sidebar-page-container">
    	<div class="auto-container">
                ...
                <div class="content-side col-lg-8 col-md-12 col-sm-12">
					...
					<div class="blog-detail">
						<div class="inner-box">
							...
							<div class="image">
								<img src="<?php echo $base_url . $blog['BlogCover'];?>" alt="" />
								<div class="category"><?php echo $blog['BlogCat'];?></div>
								<ul class="post-meta">
									<li><span class="icon flaticon-timetable"></span><?php echo $blog['Date'];?></li>
								</ul>
							</div>
							<div class="lower-content">
								<h3><?php echo $blog['BlogName'];?></h3>
								<p><?php echo $blog['BlogDescribe'];?></p>
								<div class="two-column">
									<div class="row clearfix">
										<!-- Column -->
										<div class="column col-sm-12">
											<div class="image">
												<img src="<?php echo $base_url . $blog['BlogPhoto'];?>" alt="" />
											</div>
										</div>
								...
								<div class="post-share-options">
									<div class="post-share-inner clearfix">
										<ul class="tags pull-left">
											<div class="business">Category: <a href="#"><?php echo $blog['BlogCat'];?></a></div>
										</ul>
									</div>
								</div>
							</div>
            ...
            $sql2 = $con->prepare("SELECT * FROM `blogs` WHERE BlogID !=$id");
            $sql2->execute();
            $all_blogs = $sql2->fetchAll();
							...
							<div class="sidebar-widget sidebar-blog-category">
								<div class="widget-content">
									...
									<?php foreach ($all_blogs as $blog) {?>
										...
										<li><a href="#"><?php echo $blog['BlogName'];?></a></li>
