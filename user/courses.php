    ...
    <section class="page-title" style="background-image:url(images/background/5.jpg)">
        ...
        <div class="auto-container">
			<div class="inner-container clearfix">
				<div class="pull-left">
					<h2>Our Courses</h2>
					<div class="text">Welcome To Award Winning Zatech</div>
				</div>
                ...
                <div class="filter-list row clearfix">
                    ...
                    <?php foreach ($courses as $course) {?>
                        ...
                        <div class="gallery-block-three mix web-design ux-Design col-lg-4 col-md-6 col-sm-12">
                            <div class="inner-box">
                                <div class="image-box">
                                    <img src="<?php echo $base_url . $course['CoursePhoto'];?>"/>
                                    <!-- Overlay Box -->
                                    <div class="overlay-box">
                                        <div class="overlay-inner">
                                            <div class="content">
                                                <h3><a href="projects-single.php"><?php echo $course['CourseName'];?></a></h3>
                                                <div class="separate"></div>
                                                <div class="title"><?php echo $course['CourseDescribe'];?></div>
                                            </div>
                                        </div>
                                    </div>
                                    <a data-bs-toggle="modal" data-bs-target="#exampleModal<?php echo $course['CourseID'];?>" class="link-arrow flaticon-right-arrow-1"></a>
                                </div>
                            </div>
                        </div>

                        <div class="modal fade" id="exampleModal<?php echo $course['CourseID'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-body">
                                        <form>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="Enter your E-Mail">
                                            </div>
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput3" class="form-label">Faculty</label>
                                                <input type="text" class="form-control" id="exampleFormControlInput3" placeholder="Enter your Faculty">
                                            </div>
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput4" class="form-label">Age</label>
                                                <input type="number" class="form-control" id="exampleFormControlInput4" placeholder="Enter your Age">
                                            </div>
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput5" class="form-label">Phone Number</label>
                                                <input type="number" class="form-control" id="exampleFormControlInput5" placeholder="Enter your Number">
                                            </div>
                                        </form>
                                    </div>
				...
				<div class="sidebar-textwidget">
					...
					<div class="sidebar-info-contents">
						<div class="content-inner">
							<div class="logo">
								<a href="index.php"><img src="images/cyco.png" alt="" /></a>
							</div>
							<div class="content-box">
								<h2>About Us</h2>
								<p class="text">Cyber Code is a team of creative and talented professionals who understand the importance of a high-quality work.</p>
								<a href="#" class="theme-btn btn-style-two"><span class="txt">Consultation</span></a>
							</div>
							<div class="contact-info">
								<h2>Contact Info</h2>
								<ul class="list-style-one">
									<li><span class="icon fa fa-location-arrow"></span>Egypt, Alexandria Gleem Befor SanStifano</li>
									<li><span class="icon fa fa-phone"></span> 01128120374</li>
									<li><span class="icon fa fa-envelope"></span>cybercodealexandria@gmail.com</li>
