...
$sql = $con->prepare("SELECT * FROM `projects` WHERE ProjectID = $id");
$sql->execute();
$projects = $sql->fetchAll();

$sql2 = $con->prepare("SELECT * FROM `projects` WHERE ProjectID != $id");
$sql2->execute();
$allProjects = $sql2->fetchAll();
...
<div class="page-wrapper">
    ...
    <section class="page-title" style="background-image:url(images/background/5.jpg)">
        ...
        <div class="auto-container">
			<div class="inner-container clearfix">
				<div class="pull-left">
					<h2>Project Detail Now</h2>
					<div class="text">Our Solve Projects Check Now</div>
				</div>
    ...
    <div class="sidebar-page-container">
    	<div class="auto-container">
        	<div class="row clearfix">
				...
				<!-- Content Side -->
                <div class="content-side right-sidebar col-md-12 col-sm-12">
                	<div class="project-detail">
						<div class="inner-box">
							<div class="image">
								<img src="<?php echo $base_url . $project['ProjectCover'];?>" alt="" />
							</div>
							<div class="lower-content">
								<h2><?php echo $project['ProjectName'];?></h2>
								<p><?php echo $project['ProjectDescrip'];?></p>
							</div>
						</div>
					</div>
				</div>
	...
	<section class="related-projects-section">
		...
		<div class="auto-container">
			...
			<div class="sec-title centered">
				<h2>RELATED PROJECT WORK <br> <span>SHOWCASE NOW WORK</span></h2>
			</div>
            ...
            <?php foreach ($allProjects as $project) {?>
				...
				<div class="gallery-block-three">
					<div class="inner-box">
						<div class="image-box">
							<img src="<?php echo $base_url . $project['ProjectPhoto'];?>" alt="" />
							<!-- Overlay Box -->
							<div class="overlay-box">
								<div class="overlay-inner">
									<div class="content">
										<h3><a href="projects-single.php"><?php echo $project['ProjectName'];?></a></h3>
