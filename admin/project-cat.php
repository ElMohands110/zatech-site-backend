                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <a href="backend/del.php?do=projectCat&id=<?php echo $row['CatID'];?>"><button type="button" class="btn btn-outline-danger">
                                                Delete
                                            </button></a>
                                        </div>
                                    </div>
                            ...
                            <div class="modal fade text-start" id="edit<?php echo $row['CatID'];?>" tabindex="-1" aria-labelledby="myModalLabel4" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form action="backend/edit.php?do=cat" method="post">
                                            <input type="hidden" name="catid" value="<?php echo $row['CatID'];?>">
                                            <div class="modal-body">
                                                <label>Category </label>
                                                <div class="mb-1">
                                                    <input type="text" name="catname" placeholder="category" class="form-control" value="<?php echo $row['CatName'];?>"/>
                                                </div>
                                            </div>
    ...
    <div class="modal fade text-start" id="inlineForm" tabindex="-1" aria-labelledby="myModalLabel33" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="backend/add.php?do=cat" method="POST">
                    <div class="modal-body">
                        <label>Category </label>
                        <div class="mb-1">
                            <input name="cat" type="text" placeholder="category" class="form-control" />
                        </div>
                    </div>
                    <div class="modal-footer">
                        <input name="addCat" type="submit" class="btn btn-primary" data-bs-dismiss="modal" value="Add">
                    </div>
                </form>
            </div>
        </div>
